...
public class
GetDescriberOrderActivity extends AppCompatActivity {
    Order order;
    ...
    public void setListOrders() {
        refUser.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("orders").child("commit").child(String.valueOf(number)).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                refUser.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("orders")
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        FullOrderAdapter adapter = new FullOrderAdapter(GetDescriberOrderActivity.this, R.layout.desc_order_item, order);
